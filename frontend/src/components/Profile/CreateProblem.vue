	...
	<v-container fluid class="mt-5 rounded-lg create-something">
		...
		<v-form ref="form" @submit.prevent="createProblem" class="px-5">
			...
			<v-row class="mx-2 mt-2">
				<v-col class="col-12 pa-0 mb-2"
					><p class="font-weight-bold mb-0">문제이름</p></v-col
				>
				<v-col class="col-12 pa-0">
					<v-text-field
						v-model="credentials.title"
						label="문제 이름을 입력하세요 (최대 20자)"
						maxlength="20"
						counter
						required
						dense
			...
			<v-row class="mx-2 my-2">
				<v-col class="col-12 pa-0 mb-2"
					><p class="font-weight-bold mb-0">지문</p></v-col
				>
				<v-col class="col-12 pa-0">
					<v-textarea
						v-model="credentials.mainText"
						label="지문을 입력하세요 (최대 150자)"
						maxlength="150"
						no-resize
						counter
						required
			...
			<v-row class="mx-2 mt-4">
				<v-col class="col-12 col-md-3 col-lg-2 pa-0"
					><p class="font-weight-bold mb-0">보기1 (정답)</p></v-col
				>
				<v-col class="col-12 col-md-9 col-lg-10 pa-0">
					<v-text-field
						v-model="credentials.ex1"
						label="정답이 되는 첫 번째 보기를 입력하세요"
						required
						dense
					></v-text-field>
				</v-col>
			...
			<v-row class="mx-2 mt-2">
				<v-col class="col-12 col-md-3 col-lg-2 pa-0"
					><p class="font-weight-bold mb-0">보기2</p></v-col
				>
				<v-col class="col-12 col-md-9 col-lg-10 pa-0">
					<v-text-field
						v-model="credentials.ex2"
						label="두 번째 보기를 입력하세요"
						required
						dense
					></v-text-field>
				</v-col>
			...
			<v-row class="mx-2 mt-2">
				<v-col class="col-12 col-md-3 col-lg-2 pa-0"
					><p class="font-weight-bold mb-0">보기3</p></v-col
				>
				<v-col class="col-12 col-md-9 col-lg-10 pa-0">
					<v-text-field
						v-model="credentials.ex3"
						label="세 번째 보기를 입력하세요"
						required
						dense
					></v-text-field>
				</v-col>
			...
			<v-row class="mx-2 mt-2 mb-5">
				<v-col class="col-12 col-md-3 col-lg-2 pa-0"
					><p class="font-weight-bold mb-0">보기4</p></v-col
				>
				<v-col class="col-12 col-md-9 col-lg-10 pa-0">
					<v-text-field
						v-model="credentials.ex4"
						label="네 번째 보기를 입력하세요"
						required
						dense
					></v-text-field>
				</v-col>
